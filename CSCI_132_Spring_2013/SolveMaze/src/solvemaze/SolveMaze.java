...
public class SolveMaze {
    ...
    public static void exploreMaze() {
        ...
        while (Q.peek() != null) {
            ...
            if (maze[north.i][north.j] == ' ' || maze[north.i][north.j] == 'T') {
                Q.offer(north);
                if(maze[north.i][north.j] == ' '){
                    maze[north.i][north.j] = 'b';
                }
            }
            if (maze[south.i][south.j] == ' ' || maze[south.i][south.j] == 'T') {
                Q.offer(south);
                if(maze[south.i][south.j] == ' '){
                    maze[south.i][south.j] = 'b';
                }
            }
            if (maze[west.i][west.j] == ' ' || maze[west.i][west.j] == 'T') {
                Q.offer(west);
                if(maze[west.i][west.j] == ' '){
                    maze[west.i][west.j] = 'b';
                }
            }
            if (maze[east.i][east.j] == ' ' || maze[east.i][east.j] == 'T') {
                Q.offer(east);
                if(maze[east.i][east.j] == ' '){
                    maze[east.i][east.j] = 'b';
                }
            }
    ...
    public static void main(String[] args) {
        ...
        String fileName = "src\\inputLarge.txt";
        try {
