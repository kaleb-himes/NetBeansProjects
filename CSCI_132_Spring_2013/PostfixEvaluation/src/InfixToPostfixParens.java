...
public class InfixToPostfixParens {
     ...
     */
    public String convert(String infix) throws InfixToPostfixParens.SyntaxErrorException {
        ...
        try {
            ...
            while ((nextToken = scan.findInLine(pattern)) != null) {
                ...
                if (Character.isJavaIdentifierStart(firstChar)
                    ...
                    throw new InfixToPostfixParens.SyntaxErrorException("Unexpected Character Encountered: "
                            + firstChar);
                }
            } // End while.
            ...
            while (!operatorStack.empty()) {
                ...
                if (op == '(') {
                    throw new InfixToPostfixParens.SyntaxErrorException(
            ...
            throw new InfixToPostfixParens.SyntaxErrorException("Syntax Error: The stack is empty");
        }
    }
