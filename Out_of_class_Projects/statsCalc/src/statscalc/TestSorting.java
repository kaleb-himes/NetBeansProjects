...
public class TestSorting {
    ...
    public static void printArray(double[] array) {
        ...
        statsCalcGUI.sortedTxt.append("[");
        for (int i = 0; i < array.length; i++) {
            statsCalcGUI.sortedTxt.append("  " + array[i]+"  |");
        }
        statsCalcGUI.sortedTxt.append("  ]\n-------------------------------\n");
    }
    ...
    public static void run() {
            double[] cloneArray1 = new double[statsCalcGUI.data.size()];
            double[] array1 = new double[statsCalcGUI.data.size()];
            for(int i = 0; i < array1.length; i++){
                array1[i] = statsCalcGUI.data.get(i);
            }
            ...
            statsCalcGUI.sortedData = cloneArray1.clone();
    }
}
