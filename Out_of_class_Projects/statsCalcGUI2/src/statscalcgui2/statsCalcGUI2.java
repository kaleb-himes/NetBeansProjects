 ...
 * @author Kaleb
 */
public class statsCalcGUI2 extends JFrame {

    public statsCalcGUI2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        displayDataTxt.addKeyListener(new KeyAdapter() {
    ...
    private void displayDataTxtKeyPressed(KeyEvent evt) {
    }
    ...
    public void calcMedian() {
        ...
        if (sortedData.length % 2 == 1) {
            ...
            calcQ1true(middle); //true = not divisible by 2 using true median
            calcQ3true(middle); //true = not divisible by 2 using true median
        } else {
            medianTxt.setText(Double.toString(median));
            calcQ1false(leftOfMedian); //false = use median in both Q1 and Q3 calculations
            calcQ3false(rightOfMedian);//false = use median in both Q1 and Q3 calculations
        }
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            Logger.getLogger(statsCalcGUI2.class.getName()).log(Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new statsCalcGUI2().setVisible(true);
            }
        });
    }
