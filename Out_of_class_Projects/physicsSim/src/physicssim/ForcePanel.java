        ...
        try{
            switch(action){
                ...
                case VECTOR:
                    ...
                    float newVector = Float.parseFloat(JOptionPane.showInputDialog(Main.frame, "Enter the vector's new magnitude", "Edit Vector", JOptionPane.QUESTION_MESSAGE, null, null, oldVector).toString());
