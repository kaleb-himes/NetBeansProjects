...
public class ForceList extends JPanel implements ListSelectionListener{
    ...
    class RemoveListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e){
            ...
            if(JOptionPane.showOptionDialog(Main.frame, "Are you  sure you want to delete the force '"+name+"'?", "Delete this Force?", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE, null, null, null) == JOptionPane.NO_OPTION){
                return;
            }
